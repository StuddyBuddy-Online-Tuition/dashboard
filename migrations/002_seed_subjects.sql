-- Seed Subjects Table
-- Migration: 002_seed_subjects
-- Created: 2025-10-04

-- Insert all subjects from the CSV data
INSERT INTO subjects (code, subject, standard, type, name) VALUES
-- Chemistry subjects
...
-- Bahasa Malaysia subjects (Secondary)
...
-- Mathematics subjects (Secondary)
...
-- 1-to-1 Additional Mathematics subjects
...
-- 1-to-1 Bahasa Malaysia subjects (Form)
...
-- 1-to-1 English subjects (Secondary)
...
-- 1-to-1 Mathematics subjects (Secondary)
...
-- 1-to-1 Mathematics subjects (Form)
...
-- 1-to-1 Science subjects (Secondary)
...
('GEOF5 1:1', 'Geografi ', 'F5', '1 to 1', 'Geografi  F5 - 1 to 1');
